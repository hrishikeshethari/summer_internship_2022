...
# df_train = pd.read_csv("task2b_training_imbalance_6time_str1.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str1.csv")

# df_train = pd.read_csv("task2b_training_no_imbalance_6time_str1.csv")
# df_test = pd.read_csv("task2b_test_no_imbalance_6time_str1.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2.csv")

# df_train = pd.read_csv("task2b_training_no_imbalance_6time_str2.csv")
# df_test = pd.read_csv("task2b_test_no_imbalance_6time_str2.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_commons_math.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_commons_math.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_freemarker.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_freemarker.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_derby.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_derby.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_ant_ivy.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_ant_ivy.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_kafka_commit.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_kafka_commit.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_storm_commit.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_storm_commit.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_kafka_issue2.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_kafka_issue2.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_storm_issue2.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_storm_issue2.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_kafka_commit_20.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_kafka_commit_20.csv")

# df_train = pd.read_csv("task2b_training_imbalance_6time_str2_storm_commit_20.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_storm_commit_20.csv")

df_train = pd.read_csv("task2b_training_6time_str2_kafka_source.csv")
df_test = pd.read_csv("task2b_test_imbalance_6time_str2_kafka_source.csv")

# df_train = pd.read_csv("task2b_training_6time_str2_storm_commit.csv")
# df_test = pd.read_csv("task2b_test_imbalance_6time_str2_storm_commit.csv")
