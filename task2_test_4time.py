...
class Task2:
    ...
    def print_data(self, project):
        ...
        for commit in self.commit_time:
            if self.commit_project_data[commit] == project:
                if t1 <= self.commit_time[commit] <= t4:
                    c1 = c1 + 1
                    if c1 == math.ceil((1 / 3) * c):
                        print(f"Ceil value of 1/3 of c : {c1}")
        ...
        for commit in self.commit_time:
            if self.commit_project_data[commit] == project:
                if t1 <= self.commit_time[commit] <= t4:
                    c2 = c2 + 1
                    if c2 == math.ceil((2 / 3) * c):
                        print(f"Ceil value of 2/3 of c : {c2}")
    ...
    def build_link_prediction(self):
        ...
        result_file = open("F:\\task2_test_no_imbalance.csv", "w")
