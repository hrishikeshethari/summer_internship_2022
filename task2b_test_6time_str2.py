...
class Task2:
    ...
    def build_link_prediction(self):
        ...
        result_file = open("F:\\task2b_test_imbalance_6time_str2_storm_commit_20.csv", "w")
...
if __name__ == "__main__":
    ...
    # t.build_test_file1("commons-math")
    # t.build_test_file2("commons-math")
    # t.print_data("freemarker")
    # t.build_test_file1("freemarker")
    # t.build_test_file2("freemarker")
    t.print_data("storm")
    t.build_test_file1("storm")
    t.build_test_file2("storm")
    # t.print_data("ant-ivy")
    # t.build_test_file1("ant-ivy")
    # t.build_test_file2("ant-ivy")
    # t.print_data("zookeeper")
    # t.build_test_file1("zookeeper")
    # t.build_test_file2("zookeeper")
    # t.print_data("derby")
    # t.build_test_file1("derby")
    # t.build_test_file2("derby")
    t.compare_graph()
